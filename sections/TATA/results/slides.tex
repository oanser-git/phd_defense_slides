...
\begin{frame}{Test-set Augmentation — Metrics}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\setbeamercolor{impactbox}{use={alerted text, normal text}, fg=black, bg=alerted text.fg!18!normal text.bg}
		\begin{overlayarea}{\linewidth}{0.12\textheight}
			\only<3->{%
				\begin{beamercolorbox}[rounded=true,shadow=true,wd=\linewidth,sep=1.0ex,center]{impactbox}
					\normalsize\textbf{What is the impact on NIDS performance?}
				\end{beamercolorbox}}
		\end{overlayarea}
