...
\begin{frame}{Part II conclusion}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{itemize}
			...
			\item[]
			      \tataGapClosureVisual
			\item Across \textbf{12 public NIDS datasets}, metrics remain mostly below \textbf{0.5} \(\Rightarrow\) limited test-set difficulty.
		\end{itemize}

		\column{0.40\linewidth}
		\centering
		\includegraphics[width=\linewidth]{sections/TATA/results/figures/datasets_analysis-crop-transparent.pdf}
		\par\vspace{0.25em}
		{\scriptsize 12 public NIDS datasets ordered on the x-axis by release year (2009--2020)}
	\end{columns}
\end{frame}
