...
% ------------------------------------------------------------
% Slide 2 – Benchmark splits & their limits
% ------------------------------------------------------------
\begin{frame}{Benchmark NIDS datasets}
...
\begin{frame}{Part I conclusion}
	...
	\begin{itemize}
		...
		\item TATA provides a pre-deployment framework to assess whether a \(\mathcal{D}_{\text{test}}\) really challenges a NIDS.
		\item Targeted augmentation with a configurable live testbed exposes hidden weaknesses while preserving realistic traffic generation.
		\item Across \textbf{12 public NIDS datasets} released between \textbf{2009 and 2020}, the metrics remain mostly below \textbf{0.5}, suggesting only limited test-set difficulty.
		\item A more reliable pre-deployment evaluation is necessary, but not sufficient; robust ML-based NIDS also require post-deployment adaptation.
	\end{itemize}
\end{frame}
